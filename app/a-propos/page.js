      ...
      <section className="container-px mx-auto max-w-6xl py-14 sm:py-20">
        <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-2">
          <div>
            ...
            <Link
              href="/services"
              className="mt-6 inline-flex items-center gap-2 font-body text-sm font-semibold text-navy-800 underline decoration-gold-500 decoration-2 underline-offset-4"
            >
