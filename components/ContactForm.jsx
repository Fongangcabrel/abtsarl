    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div>
        ...
        <input
          ...
          className="w-full rounded-xl border border-navy-100 bg-white px-4 py-3 font-body text-sm text-ink-900 placeholder:text-ink-500/60 focus:border-navy-600"
        />
      </div>
      ...
      <button
        ...
        className="w-full rounded-full bg-navy-800 px-6 py-3.5 font-body text-sm font-semibold text-white transition-colors hover:bg-navy-700 disabled:opacity-60"
      >
