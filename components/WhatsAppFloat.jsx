export default function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/20 transition-transform duration-300 hover:scale-110 active:scale-95"
    >
      {/* halo qui pulse toutes les 6 s, assez espacé pour ne pas distraire */}
      <span
        className="soft-ping absolute inset-0 rounded-full bg-[#25D366]"
        aria-hidden="true"
      />
      <svg
        viewBox="0 0 32 32"
